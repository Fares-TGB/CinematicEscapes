...
description: Create visually distinctive, high-impact frontend interfaces with bold typography, cinematic color themes, orchestrated animations, and atmospheric backgrounds. Use when building UI that needs to stand out.
---
